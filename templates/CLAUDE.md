...
## MCPs
Project `.mcp.json` und user-global MCPs (`~/.claude/mcp.json`) sind aktiv — bei Domain-Match (Storyblok, Shopify, Coolify, Crewbuddy, etc.) MCP-Tools zuerst nutzen, nicht WebFetch oder raten.
