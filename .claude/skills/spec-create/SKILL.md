---
name: spec-create
description: Create a new spec for a task. Use when the user says "create a spec for X", "write a spec for X", "spec out X", or "plan X as a spec". A spec is a structured implementation plan that lives in specs/NNN-title.md.
---
