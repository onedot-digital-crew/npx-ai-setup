---
name: spec-validate
description: Validate a draft spec before execution. Use when the user says `/spec-validate NNN`, "validate spec NNN", or "check whether a spec is ready to execute".
---
