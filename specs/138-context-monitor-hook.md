...
> **Spec ID**: 138 | **Created**: 2026-03-22 | **Status**: in-review | **Complexity**: medium | **Branch**: main
...
- [x] Step 4: Add hook install step to `bin/ai-setup.sh` (copy hook file, register in settings)
...
## Files to Modify
- `templates/hooks/context-monitor.js` — new file
