...
cleanup_known_orphans() {
  local -a orphans=(
    ...
    ".claude/skills/spec-validate"
    ".claude/skills/apply-learnings"
    ".claude/skills/architectural-decisions"
    ".claude/skills/build-fix"
    ".claude/skills/ci"
    ".claude/skills/claude-changelog"
    ".claude/skills/context-load"
    ".claude/skills/context-refresh"
    ".claude/skills/debug"
    ...
    ".claude/skills/pr"
    ".claude/skills/pre-modification"
    ".claude/skills/scan"
    ".claude/skills/project-audit"
    ".claude/skills/spec-create"
    ".claude/skills/spec-run"
    ".claude/skills/spec-run-all"
    ".claude/skills/techdebt"
    ".claude/skills/test-setup"
    ".claude/skills/test-audit-setup"
